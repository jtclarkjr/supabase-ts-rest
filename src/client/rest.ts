...
export function createRestMethods(doRequest: DoRequestFn) {
   ...
   * @returns The API response
   */
  async put(endpoint: string, primaryKeyName: string, primaryKeyValue: string, data: unknown): Promise<unknown> {
   ...
   * @returns The API response
   */
  async patch(endpoint: string, queryParams: QueryParams, data: unknown): Promise<unknown> {
   ...
   * @returns The API response
   */
  async del(endpoint: string, primaryKeyName: string, primaryKeyValue: string): Promise<unknown> {
      const queryParams = { [primaryKeyName]: primaryKeyValue };
