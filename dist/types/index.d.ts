...
export type OAuthProvider = 'apple' | 'azure' | 'bitbucket' | 'discord' | 'facebook' | 'figma' | 'github' | 'gitlab' | 'google' | 'kakao' | 'keycloak' | 'linkedin_oidc' | 'notion' | 'twitch' | 'twitter' | 'slack_oidc' | 'slack' | 'spotify' | 'workos' | 'zoom';
